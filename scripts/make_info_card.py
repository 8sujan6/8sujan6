...
BG = "#0d1117"
BG2 = "#060a12"
FRAME = "#ffcc00"     # Pac-Man Yellow arcade frame
MUTED = "#7d8590"
INK = "#ffffff"
KEY = "#ffcc00"       # Pac-Man Yellow keys
SECTION = "#00ffff"   # Cyan ghost section headers
GREEN = "#00ff66"     # Arcade Neon Green
ACCENT = "#ff0000"    # Blinky Red accent
